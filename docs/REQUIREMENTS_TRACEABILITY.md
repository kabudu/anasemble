...
| REL-6 | Prepare a source-only release without conflating preparation and publication | versioned curated title/body, `publish = false`, source inventory and fail-closed opening runbook | repository checker, Cargo package inventory, history secret scan and unchecked publication gates |
